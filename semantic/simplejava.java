...
public class simplejava implements simplejavaConstants {
        public static boolean emptyparams = true;       //used for followsvariablenames()
...
ASTFunctionCallStatement funccallstate = null; ASTStatement params = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case DO:{
...
avariable = new ASTBaseVariable(arrayvariabletoken.image, arrayvariabletoken.beginLine);
      ...
      case MINUSMINUS:{
        ...
        case ADD:
        case MINUSMINUS:{
          expression = followsvariablenames(token);
          break;
          }
        case LEFT_PARENTHESIS:{
...
initvar = new ASTBaseVariable(identifier.image, identifier.beginLine);
      initexp = followsvariablenames(identifier);
...
{if ("" != null) return nullcase;}
  ...
  static final public ASTExpression followsvariablenames(Token token) throws ParseException {ASTExpression value = null; ASTBaseVariable basevar = new ASTBaseVariable(token.image, token.beginLine);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case GETS:{
